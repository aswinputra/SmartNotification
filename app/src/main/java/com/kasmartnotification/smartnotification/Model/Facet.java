...
public class Facet {
    ...
    public static void setDefaultValues() {
        ...
        SugarHelper.createOrSetDBObject(BlackListPackage.class, Constants.PACKAGE_NAME, null, null, null, 0);

        SugarHelper.createOrSetDBObject(ReminderMessage.class, "Would you like to turn on Smart Notification?", null, TURN_ON, null, 0);
        SugarHelper.createOrSetDBObject(ReminderMessage.class, "Are you sure you don't want to turn it on?", null, TURN_ON, null, 0);
        SugarHelper.createOrSetDBObject(ReminderMessage.class, "Would you like to turn off Smart Notification?", null, TURN_OFF, null, 0);
